export function Footer() {
  return (
    <footer className="py-12 md:py-20 px-6 border-t border-zinc-100 bg-white">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-8 text-sm font-medium text-zinc-400">
