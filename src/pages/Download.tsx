  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-20">
      ...
      <div className="space-y-12">
        <section>
          <h2 className="text-2xl font-bold mb-6 text-zinc-800 flex items-center gap-2">
            <span className="bg-emerald-100 text-emerald-600 px-3 py-1 rounded-full text-sm">1</span>
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-zinc-100 shadow-sm">
            ...
            <div className="bg-zinc-900 p-5 rounded-2xl font-mono text-sm text-emerald-400 mb-4 overflow-x-auto">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-6 text-zinc-800 flex items-center gap-2">
            <span className="bg-emerald-100 text-emerald-600 px-3 py-1 rounded-full text-sm">2</span>
            Outras Formas de Uso
          </h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-[2rem] border border-zinc-100 shadow-sm">
              <h3 className="text-xl font-bold mb-4 text-emerald-600">Execução Direta</h3>
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-zinc-100 shadow-sm">
              <h3 className="text-xl font-bold mb-4 text-emerald-600">Alias Manual</h3>
              ...
              <div className="bg-zinc-900 p-4 rounded-xl font-mono text-xs text-emerald-400 mb-4 break-all">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-emerald-50 p-8 rounded-[2rem] border border-emerald-100">
            <h2 className="text-xl font-bold mb-4 text-emerald-800">Extensão VS Code</h2>
          ...
          <div className="bg-zinc-50 p-8 rounded-[2rem] border border-zinc-200">
            <h2 className="text-xl font-bold mb-4 text-zinc-800">Build Local</h2>
