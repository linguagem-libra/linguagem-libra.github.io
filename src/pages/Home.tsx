      ...
      <main className="max-w-6xl mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight mb-6 text-zinc-900 leading-[1.15]">
              Aprenda a programar no <span className="text-emerald-500">seu idioma</span>.
            </h1>
            <p className="text-lg md:text-xl text-zinc-500 mb-10 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/baixar" className="bg-emerald-500 text-white px-8 py-4 rounded-2xl text-lg font-bold hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-100 flex items-center gap-2">
                Baixar Libra
              </Link>
              <a href="https://testar.linguagemlibra.site" target="_blank" className="bg-zinc-50 text-zinc-600 px-8 py-4 rounded-2xl text-lg font-bold hover:bg-zinc-100 transition-all border border-zinc-200 flex items-center gap-2">
                Testar no Navegador
          ...
          <div className="relative">
            ...
            <div className="bg-[#1e1e1e] rounded-[2rem] p-8 shadow-2xl shadow-emerald-200/50 relative overflow-hidden border border-zinc-800">
              ...
              <pre className="font-mono text-sm md:text-base leading-relaxed text-zinc-300">
                {codeExample}
              </pre>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {syntaxItems.map((item, i) => (
              <div key={i} className="bg-white p-8 rounded-[2rem] shadow-sm border border-zinc-100 hover:shadow-xl hover:shadow-emerald-500/5 transition-all group">
                ...
                <code className="block bg-zinc-50 p-4 rounded-xl text-zinc-700 font-mono text-sm group-hover:bg-emerald-50 group-hover:text-emerald-700 transition-colors border border-zinc-100">
                  {item.example}
                </code>
              </div>
            ))}
